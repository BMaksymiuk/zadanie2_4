...
public class Main {
  public static void main(String[] args) {
    ...
    System.out.printf("wybierz operacje: (1 – dla sumy, 2 – dla różnicy, 3 – dla iloczynu, 4 – dla ilorazu), 5 - pole prostokata, 6 - pole trojkata, 7 - suma              kwadratow, 8 -  \n");
    ...
    switch(operacja){
      ...
      case 5:
        ...
        System.out.printf("pole prostokata: %d\n", poleProstokata);
        break;
      case 6:
        ...
        System.out.printf("pole trojkata: %d\n", poleTrojkata);
        break;
      case 7:
        System.out.printf("podaj c: \n");
        c = skaner.nextDouble();
        double sumaKwadratow = Math.pow(a,2) + Math.pow(b,2) + Math.pow(c,2);
        System.out.printf("suma kwadratow: %d\n", sumaKwadratow);
        break;
      case 8:
